...
The program allows the user to create different geometric shapes on the screen using the mouse and change both colors and line thickness using the keyboard. most modifications were implemented directly in the original paint.py source file.
...
Additional colors were implemented to create a more dynamic and user-friendly drawing experience.
